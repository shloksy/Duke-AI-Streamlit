        ...
        {page === 'newUser' && !isFormSubmitted && (
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6 text-left">
                ...
                <input className="block w-full p-3 border border-gray-300 rounded" type="text" id="childName"
              ...
              <div className="mb-6 text-left">
                ...
                <select className="block w-full p-3 border border-gray-300 rounded" id="gradeLevel" value={gradeLevel}
              ...
              <div className="mb-6 text-left">
                ...
                <input className="block w-full p-3 border border-gray-300 rounded" type="text" id="parentName"
                       value={parentName} onChange={(e) => setParentName(e.target.value)}/>
              </div>
              <div className="mb-6 text-left">
                <label className="block text-lg text-gray-600 mb-2" htmlFor="parentEmail">Parent's Email:</label>
                <input className="block w-full p-3 border border-gray-300 rounded" type="email" id="parentEmail"
              ...
              <div className="mb-6 text-left">
                ...
                <input className="block w-full p-3 border border-gray-300 rounded" type="password" id="password"
                       value={password} onChange={(e) => setPassword(e.target.value)}/>
              </div>
              <button
                  className="button-hover-effect bg-gray-500 hover:bg-gray-700 text-white font-bold py-3 px-6 rounded mt-4"
                  type="button" onClick={() => setPage('selectUserType')}>Back
              </button>
              <button
